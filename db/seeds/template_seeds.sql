...
-- ============================================================
-- [21] カテゴリ直下・全般テンプレート（チーム問わず・全体好き向け）
-- ============================================================

insert into memoria.template_nodes (name, path, questions) values

('野球好き（チーム問わず）', array['スポーツ','野球'], '[
  {"label":"野球を好きになったきっかけは？","placeholder":"例：父に連れて行ってもらった球場観戦"},
  {"label":"推しチームは？（あれば）","placeholder":"例：特定チームはなく試合全般が好き"},
  {"label":"観戦スタイルは？","placeholder":"例：球場で生観戦派、年10試合は行く"},
  {"label":"好きなポジションは？","placeholder":"例：投手戦が好き、特にクローザー"},
  {"label":"プロ野球・高校野球どちらが好き？","placeholder":"例：甲子園の高校野球が大好き"},
  {"label":"野球観戦の楽しみ方は？","placeholder":"例：スコアをつけながら見る"},
  {"label":"野球のここが好き！","placeholder":"例：間と駆け引きがある、頭脳スポーツだと思う"}
]'),

('サッカー好き（クラブ問わず）', array['スポーツ','サッカー'], '[
  {"label":"サッカーを好きになったきっかけは？","placeholder":"例：2002年W杯で日韓開催を見て"},
  {"label":"推しクラブは？（あれば）","placeholder":"例：特定クラブはなく代表が中心"},
  {"label":"観戦スタイルは？","placeholder":"例：スタジアム現地派、雰囲気が好き"},
  {"label":"好きなポジションは？","placeholder":"例：トップ下、司令塔タイプが好き"},
  {"label":"Jリーグと海外サッカー、どちらが好き？","placeholder":"例：両方、時期で使い分けてる"},
  {"label":"日本代表の応援はする？","placeholder":"例：W杯はガチ勢になる"},
  {"label":"サッカーのここが好き！","placeholder":"例：90分間の緊張感と逆転劇"}
]'),

('Jリーグ好き（クラブ問わず）', array['スポーツ','サッカー','Jリーグ'], '[
  {"label":"Jリーグを見始めたきっかけは？","placeholder":"例：地元クラブができてから"},
  {"label":"推しクラブは？","placeholder":"例：地元クラブを応援しつつ試合全体も好き"},
  {"label":"スタジアム観戦はどのくらい行く？","placeholder":"例：年20試合くらい"},
  {"label":"席のこだわりは？","placeholder":"例：ゴール裏で声出し派"},
  {"label":"アウェー遠征はしてる？","placeholder":"例：年2〜3回は遠征する"},
  {"label":"Jリーグのここが好き！","placeholder":"例：地域密着で応援しがいがある"}
]'),

('STARTO担（グループ問わず）', array['音楽・アイドル','STARTO'], '[
  {"label":"STARTOにハマったきっかけは？","placeholder":"例：テレビで見て一目惚れ"},
  {"label":"推しグループは？","placeholder":"例：複数掛け持ち中"},
  {"label":"現場（コンサート）には行く？","placeholder":"例：年5〜6回は行ってる"},
  {"label":"担降り経験はある？","placeholder":"例：最初はA担だったけど今はB担"},
  {"label":"グッズ収集はしてる？","placeholder":"例：推しのうちわだけ集めてる"},
  {"label":"ガチ度は？","placeholder":"例：ライトな感じだけど現場は欠かさない"},
  {"label":"今いちばん熱い推しは？","placeholder":"例：最近○○に沼落ちした"}
]'),

('KPOPファン（グループ問わず）', array['音楽・アイドル','KPOP'], '[
  {"label":"KPOPにハマったきっかけは？","placeholder":"例：友達に勧められたMVで"},
  {"label":"好きなグループは？","placeholder":"例：複数掛け持ち、ジャンル問わず好き"},
  {"label":"男女どちらのグループが好み？","placeholder":"例：男性グループメイン、たまに女性も"},
  {"label":"KPOPの何が一番好き？","placeholder":"例：振り付けとビジュアルの完成度"},
  {"label":"韓国語は勉強してる？","placeholder":"例：ハングル読める程度"},
  {"label":"コンサートに行ったことある？","placeholder":"例：アリーナ公演年2回ペース"},
  {"label":"韓国に行ったことある？","placeholder":"例：聖地巡礼で3回行った"},
  {"label":"推しのここが好き！","placeholder":"例：パフォーマンス中の表情が好き"}
]'),

('坂道・48ファン（グループ問わず）', array['音楽・アイドル','坂道・48'], '[
  {"label":"ハマったきっかけのグループ・曲は？","placeholder":"例：「ハルジオンが咲く頃」で沼落ち"},
  {"label":"推しグループは？","placeholder":"例：複数掛け持ちしてる"},
  {"label":"推しメンは？","placeholder":"例：今は○○推し、前は△△推しだった"},
  {"label":"現場（握手会/コンサート）には行く？","placeholder":"例：コンサートは全通じゃないけど行く"},
  {"label":"坂道と48、どちらが好み？","placeholder":"例：坂道メインだけど48も好き"},
  {"label":"ガチ度は？","placeholder":"例：のんびりTVで追ってる感じ"},
  {"label":"今いちばん熱い推しは？","placeholder":"例：最近○○が気になってる"}
]'),

('アニメ・マンガ好き（全般）', array['アニメ・ゲーム','アニメ・マンガ'], '[
  {"label":"アニメにハマったきっかけ作品は？","placeholder":"例：小学生のときのドラゴンボール"},
  {"label":"好きなジャンルは？","placeholder":"例：少年バトル・異世界転生・日常系"},
  {"label":"原作派？アニメ派？","placeholder":"例：原作先に読んでからアニメを楽しむ"},
  {"label":"年何作品くらい追ってる？","placeholder":"例：クールごとに5〜10作品"},
  {"label":"聖地巡礼はしてる？","placeholder":"例：好きな作品は必ず行く"},
  {"label":"グッズは集める？","placeholder":"例：フィギュアとキャラグッズが中心"},
  {"label":"布教したい作品は？","placeholder":"例：「鬼滅の刃」は全人類見てほしい"},
  {"label":"最近いちばん刺さった作品は？","placeholder":"例：最近○○が刺さりすぎてる"}
]'),

('VTuber・配信好き（全般）', array['音楽・アイドル','VTuber・配信'], '[
  {"label":"VTuberを見始めたきっかけは？","placeholder":"例：友達の配信切り抜きで知った"},
  {"label":"推しVTuberは？","placeholder":"例：複数掛け持ち中"},
  {"label":"毎日チェックしてる？","placeholder":"例：通知オンにして欠かさず見てる"},
  {"label":"スパチャは送る？","placeholder":"例：特別な配信の時だけ"},
  {"label":"企業箱と個人、どちらが好み？","placeholder":"例：両方好き、コンテンツ次第"},
  {"label":"VTuberのここが好き！","placeholder":"例：中の人が見えないからこそ没入できる"},
  {"label":"グッズは買う？","placeholder":"例：アクスタとボイスパックは必ず買う"}
]'),

('ソシャゲ・RPG好き（全般）', array['アニメ・ゲーム','ソシャゲ・RPG'], '[
  {"label":"今メインでやってるゲームは？","placeholder":"例：○○が今のメインです"},
  {"label":"課金スタイルは？","placeholder":"例：無課金/月1000円くらい/課金は気にしない"},
  {"label":"推しキャラは？","placeholder":"例：○○が好きで全コス持ってる"},
  {"label":"いくつのゲームを並行してる？","placeholder":"例：今は3本掛け持ち"},
  {"label":"ランキングは追う？","placeholder":"例：イベントランキングは必ず走る"},
  {"label":"リセマラはする？","placeholder":"例：推しキャラが出るまでやる派"},
  {"label":"ゲームのここが好き！","placeholder":"例：ストーリーとキャラクターの深さ"}
]');
